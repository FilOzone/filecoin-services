...
export SESSION_KEY_REGISTRY_ADDRESS=$(forge create --broadcast --nonce $NONCE lib/session-key-registry/src/SessionKeyRegistry.sol:SessionKeyRegistry | grep "Deployed to" | awk '{print $3}')
