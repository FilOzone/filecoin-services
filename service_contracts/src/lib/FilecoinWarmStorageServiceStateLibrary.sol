...
library FilecoinWarmStorageServiceStateLibrary {
     ...
     */
    function getPriceListUSDC(FilecoinWarmStorageService service) public view returns (PriceList memory list) {
        list = priceListUSDC();
     ...
     */
    function getUSDCCommissionBps(FilecoinWarmStorageService service) public view returns (uint256) {
